    ...
    <Transition>
        <div>
            ...
            <nav v-if="authenticatedUser" class="opacity-100 w-36">
                <ul id="navbarSupportedContent" :class="{mainmenu: mainMenuIsOpen}" class="w-44 absolute -translate-x-32 transition-transform ease-in-out duration-500 h-full sm:block border sm:border-none bg-gray-400 sm:visible">
