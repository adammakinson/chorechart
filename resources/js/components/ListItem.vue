<template>
    <li :id="listItem.id" class="list-group-item justify-between items-center bg-white" v-bind:data-itemId="listItem.id" v-on:click="handleChoreClick" v-on:dragstart="dragStart" draggable="draggable">
