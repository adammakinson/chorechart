<template>
    <div class="modalWrapper invisible w-full max-w-full max-h-full h-full overscroll-none absolute bg-gray-800 bg-opacity-50 top-0 left-0 grid justify-center content-center">
            <div v-bind:id="id" @close-modal="closeModal" class="modal invisible bg-white w-auto mr-5 sm:w-96 border rounded-md shadow-md" tabindex="-1" role="dialog">
